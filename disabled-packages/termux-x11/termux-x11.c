...
# define TERMUX_PREFIX "/data/data/com.winlator/files/usr"
#endif

#ifndef TERMUX_X11_DIR
# define TERMUX_X11_DIR "/data/data/com.winlator.x11/"
#endif
...
int main(int argc, char *argv[]) {
	...
	char *server_argv[] = {TERMUX_PREFIX "/bin/am", "start", "-n", "com.winlator.x11/.MainActivity", NULL};
