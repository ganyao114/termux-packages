...
#define SERVER_PORT 7810
#define CLIENT_PORT 7812
#define BUFFER_SIZE 64

#define REQUEST_CODE_GET_GAMEPAD 1
#define REQUEST_CODE_GET_GAMEPAD_STATE 2
#define REQUEST_CODE_RELEASE_GAMEPAD 3
