...
TERMUX_PKG_SRCURL="git+https://github.com/wine-mirror/wine"
TERMUX_PKG_GIT_BRANCH="master"
TERMUX_PKG_VERSION="$BUILD_PKG_VERSION"
...
termux_step_host_build() {
	...
	# Patch stagings
	git clone -b v$TERMUX_PKG_VERSION https://github.com/wine-staging/wine-staging.git
	# esync
  ...
  sed -i '/#include "esync.h"/a #include "../shm_patch.h"' $TERMUX_PKG_SRCDIR/server/esync.c
  sed -i '/#include "esync.h"/a #include "../../../shm_patch.h"' $TERMUX_PKG_SRCDIR/dlls/ntdll/unix/esync.c
